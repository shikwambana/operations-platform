...
children: [{path: 'myapprovals', component: myapprovalsComponent},{path: 'applyleave', component: applyleaveComponent},{path: 'userdetail', component: userdetailComponent},{path: 'userregistration', component: userregistrationComponent},{path: 'myleaves', component: myleavesComponent},{path: 'myprofile', component: myprofileComponent}]},{path: '', redirectTo: '/login', pathMatch: 'full'},{path: '**', component: PageNotFoundComponent}]
